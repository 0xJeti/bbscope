...
import (
	...
	"github.com/0xJeti/bbscope/pkg/platforms/hackerone"
)
...
func main() {
	...
	scope, _ := hackerone.GetAllProgramsScope(b64.StdEncoding.EncodeToString([]byte(*userFlag+":"+*tokenFlag)), true, true, false, "all", true, 2, false, "", "", false)
